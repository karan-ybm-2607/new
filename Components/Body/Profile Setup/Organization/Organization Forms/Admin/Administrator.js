        ...
        <div className={classes.root}>
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                <AccordionSummary
                    ...
                    id="panel1bh-header"
                >
                    <Typography className={classes.heading}>CEO</Typography>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                <AccordionSummary
                    ...
                    id="panel2bh-header"
                >
                    <Typography className={classes.heading}>HR Admin</Typography>
                    <Typography className={classes.secondaryHeading}>
                        1 person added
                    </Typography>
                </AccordionSummary>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                <AccordionSummary
                    ...
                    id="panel3bh-header"
                >
                    <Typography className={classes.heading}>Finance Admin</Typography>
                    <Typography className={classes.secondaryHeading}>
                        No one added
                    </Typography>
                </AccordionSummary>
