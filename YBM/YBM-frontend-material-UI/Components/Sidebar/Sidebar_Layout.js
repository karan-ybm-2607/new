...
const Sidebar_Layout = (props) => {
  ...
  const { SubMenuOpen, handleListItemClick, selectedIndex, SubMunuHandeler } =
    props;
      ...
      <List component="nav" aria-label="main mailbox folders">
        ...
        >
          ...
          <ListItemIcon>
            ...
            <FaChartPie
              fontSize={22}
              fill={THEME_COLOR.Theme_light_dark}
            />{" "}
          </ListItemIcon>{" "}
        ...
        <ListItem
          ...
          onClick={(event) => SubMunuHandeler(event, 1)}
          className={classes.navItems}
        >
          {" "}
          <ListItemIcon>
        ...
        <Collapse in={SubMenuOpen} timeout="auto" unmountOnExit>
          ...
          <List component="div" disablePadding>
            ...
            >
              ...
              <ListItemIcon>
                {" "}
                <AccountCircleIcon fill={THEME_COLOR.Theme_light_dark} />{" "}
              </ListItemIcon>{" "}
              <ListItemText primary="Salary Structure" />{" "}
            </ListItem>{" "}
          </List>{" "}
        </Collapse>{" "}
        <ListItem
